...
<span class="auth__subtitle">Please enter your details</span>
      <form @submit.prevent="handleLogin" class="form__login">
        <input type="email" v-model="username" placeholder="Your email" required />
        <input
          type="password"
          v-model="password"
   ...
   <div class="form__login-register">
    <a href="#">Forgot Password?</a>
        ...
        <div class="button__group">
          ...
          <button @click="handleRegister"  id="registationButton">Don’t have an account? <strong>Sign Up</strong></button>   
      </form>
    </div>
  </div>
</template>
...
display: flex;
 ...
 #registationButton{
  background: none;font-size: 0.778rem;
    line-height: 0.933rem;
    font-weight: 500;
    color: #8A7D80;
    text-transform: none;
