<script setup>
  ...
  const selectedFurnisher = ref(props.data.furnishing || "");

  const formData = ref({
    floorLevel: props.data.floorLevel || "",
    nFloors: props.data.nFloors || "",
    totalArea: props.data.totalArea || "",
    lendArea: props.data.lendArea || "",
    floorArea: props.data.floorArea || "",
    bedroom: props.data.bedroom || "",
    bathroom: props.data.bathroom || "",
    parking: props.data.parking || "",
    furnishing: props.data.furnishing || "",
  });
